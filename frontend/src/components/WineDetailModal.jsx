    ...
    >
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:max-h-[90vh]">
          ...
          <div className="relative md:w-[45%] md:flex-shrink-0 max-h-[30vh] md:max-h-none overflow-hidden">
            <ImageCarousel images={images} wineName={wine.name} wineType={wine.wine_type} overlay />
          </div>

          {/* Content — right side on desktop, bottom on mobile */}
          <div data-modal-content className="flex-1 overflow-y-auto p-5 sm:p-8 space-y-4 sm:space-y-5">
